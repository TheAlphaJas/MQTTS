...
titw_metadata_path = '/home/jasmer/Desktop/TITW_Data/titw_easy_metadata/bonafide_metadata_cfg_v3'
titw_audio_path = '/home/jasmer/Desktop/TITW_Data/titw-easy-audio'
output_dir = './DFF/'  # This will be created inside the MQTTS directory

# Splitting configuration
SOURCE_DATA_SPLIT = 'dev' # The split to be partitioned into train/validation
VALIDATION_SET_RATIO = 0.10 # Use 15% of the data for validation
RANDOM_SEED = 42536475 # For reproducible splits
